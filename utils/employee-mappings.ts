  ...
  export const officeMapping: Record<string, string> = {
  ...
  export const eligibilityMapping: Record<string, string> = {
  ...
  export const appointmentMapping: Record<string, string> = {
