...
const EmployeesPage = async ({
  ...
  // Get distinct positions for this department
  const rawPositions = await prismadb.employee.findMany({
  ...
  // Map to Option[] and drop blanks/nulls
  const positionOptions = rawPositions
