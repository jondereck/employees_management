...
const Info = ({
  ...
  return (
    <div
    className="bg-white p-6 rounded-xl shadow-lg border-4 print:border-0 print:shadow-none print:p-0 print:rounded-none transition-shadow duration-300 hover:shadow-2xl"
  ...
  >
    ...
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
      ...
      <div className="hidden sm:flex flex-col items-center gap-4 sm:mt-1 print:hidden">
    ...
    <div className="flex items-center justify-between my-4">
      ...
      {data.employeeLink && (
        <Button
          ...
          className="group px-5 py-2 font-semibold text-white flex items-center gap-3 rounded-md shadow-lg transition-all hover:shadow-xl hover:scale-[1.03]"
