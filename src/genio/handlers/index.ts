export { handleWhoIs } from "./handleWhoIs";
export { handleCount } from "./handleCount";

export { handleShowProfile } from "./handleShowProfile";
export { handleDistribution } from "./handleDistribution";
export { handleInsight } from "./handleInsight";
export { handleListOffices } from "./handleListOffices";
export { handleWhoIsHead } from "./handleWhoIsHead";
